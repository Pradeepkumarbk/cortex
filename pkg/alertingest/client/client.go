...
func MakeIngesterClient(addr string, timeout time.Duration, withCompression bool) (AlertIngesterClient, error) {
	...
	return &closableIngesterClient{
		AlertIngesterClient: NewAlertIngesterClient(conn),
		conn:                conn,
	}, nil
}

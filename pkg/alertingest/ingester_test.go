...
func (s *testStore) Put(ctx context.Context, chunks []alert.Chunk) error {
	s.mtx.Lock()
	defer s.mtx.Unlock()
...
func chunksToMatrix(chunks []alert.Chunk) (model.Matrix, error) {

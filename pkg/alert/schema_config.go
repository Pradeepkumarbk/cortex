...
func (cfg *SchemaConfig) RegisterFlags(f *flag.FlagSet) {
	...
	f.StringVar(&cfg.OriginalTableName, "dynamodb.original-table-name", "cortexalerts", "The name of the DynamoDB table used before versioned schemas were introduced.")
	...
	cfg.IndexTables.RegisterFlags("dynamodb.periodic-table", "cortexalerts_", f)
	cfg.IndexTables.globalTags = &cfg.Tags
	cfg.ChunkTables.RegisterFlags("dynamodb.chunk-table", "cortexalerts_chunks_", f)

...
func NewTableClient(ctx context.Context, cfg Config) (alert.TableClient, error) {
...
func (c *tableClient) CreateTable(ctx context.Context, desc alert.TableDesc) error {
...
func (c *tableClient) DescribeTable(ctx context.Context, name string) (desc alert.TableDesc, status string, err error) {
	return alert.TableDesc{
		Name: name,
	}, dynamodb.TableStatusActive, nil
}

func (c *tableClient) UpdateTable(ctx context.Context, current, expected alert.TableDesc) error {
	return nil
}
